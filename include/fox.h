...
double SunMeanLng(double t);
double SunMeanAno(double t);
double SunMeanAno5(double t);
...
double DiffAngle(double lng1, double lat1, double lng2, double lat2);
double DiffAngle2(double lng1, double lat1, double lng2, double lat2);
double MoonMeanLng(double t);
double MoonMeanElong(double t);
double MoonMeanAno(double t);
double MoonArgLat(double t);
double SunEqn(double t, double meanano);
double Refraction(double alt);
double Refraction2(double alt, double temp, double press);
double ParallaxAU(double alt, double r);
double Parallax(double alt, double r);
double Dip(double height);
double Geodetic(double lat);
double MoonMeanNodeLng(double t);
double NutationObl(double t);
double NutationLng(double t);
double Sidereal4(double jd);
double az(double lha, double dec, double lat);
double alt(double lha, double dec, double lat);
double SunLng4(double t);
double SunAno4(double t);
double SunR(double t);
...
double SunSemiDia(double t);
double MoonSemiDia(double t);
double MoonMonthPhase(double t);
double MoonVisualPhase(double t);
double MoonLng4(double t);
double MoonLat4(double t);
double MoonR(double t);
double MoonMeanPhase(double K, double t);
double IsEql(double v1, double v2, double maxdiff);
double LunationDate(double lun);
double lha(double RA, double sidereal, double lng);
double CosHA(double alt, double decl, double lat);
double AltHA(double alt, double direction, double dec, double lat);
double RiseSet(double jd, double t, double elng, double elat, double alt, double direction, double lng, double lat);
double SunTransit(double jd, double lng, double lat);
double SunRiseSet(double alt, double direction, double jd, double lng, double lat);
double MoonRiseSet(double alt, double direction, double jd, double lng, double lat);
double SunRise(double jd, double lng, double lat);
double SunSet(double jd, double lng, double lat);
double MoonRise(double jd, double lng, double lat);
double MoonSet(double jd, double lng, double lat);
double SunRA(double t);
double SunDec(double t);
double MoonRA(double t);
double MoonDec(double t);
double SunAz(double jd, double lng, double lat);
double SunAlt(double jd, double lng, double lat);
double MoonAz(double jd, double lng, double lat);
double MoonAlt(double jd, double lng, double lat);
double MoonPositionAngle(double t);
double MoonZenithAngle(double jd, double lng, double lat);
double YallopBestTime(double jd, double lng, double lat);
double ARCL(double jd, double lng, double lat);
double ARCV(double jd, double lng, double lat);
double MoonPi(double t);
double AngleSunMoon(double t);
char* yallop_name(int zone);
double TranslateYallopQ(double q);
double YallopQ2(double MoonAlt, double ArcLight, double ArcVision, double MoonR);
double YallopQ(double jd, double lng, double lat);
int HijriYear(int lun);
int HijriMonth(int lun);
double Lunation(double jd);
double NewMoon(double lun);
double FullMoon(double lun);
double MoonPhaseAngle(double t);
double moonmag(double t);
double MoonMag3(double phaseangle);
double MoonMag4(double dist, double phase);
double MoonMag2(double t);