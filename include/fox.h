...
double alt_ha(double alt, double direction, double dec, double lat);
double rise_set(double jd, double t, double elng, double elat, double alt, double direction, double lng, double lat);
double sun_transit(double jd, double lng, double lat);
double sun_rise_set(double alt, double direction, double jd, double lng, double lat);
double moon_rise_set(double alt, double direction, double jd, double lng, double lat);
