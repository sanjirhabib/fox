...
static int r_Normalize_pre(struct SN_env * z) { /* forwardmode */
    int among_var;
    {   int i; for (i = len_utf8(z->p); i > 0; i--) /* loop, line 261 */
        {               {   int c1 = z->c; /* or, line 330 */
                z->bra = z->c; /* [, line 263 */
                among_var = find_among(z, a_0, 161); /* substring, line 263 */
                if (!(among_var)) goto lab1;
                z->ket = z->c; /* ], line 263 */
                switch (among_var) { /* among, line 263 */
                    case 0: goto lab1;
                    case 1:
                        ...
                        break;
                    case 2:
                        {   int ret = slice_del(z); /* delete, line 265 */
                            if (ret < 0) return ret;
                        }
                        break;
                    case 3:
                    ...
                    case 4:
                        ...
                        break;
                    case 5:
                        {   int ret = slice_from_s(z, 1, s_0); /* <-, line 272 */
                            if (ret < 0) return ret;
                        }
                        break;
                    case 6:
                        {   int ret = slice_from_s(z, 1, s_1); /* <-, line 273 */
                            if (ret < 0) return ret;
                        }
                        break;
                    case 7:
                        {   int ret = slice_from_s(z, 1, s_2); /* <-, line 274 */
                            if (ret < 0) return ret;
                        }
                        break;
                    case 8:
                        {   int ret = slice_from_s(z, 1, s_3); /* <-, line 275 */
                            if (ret < 0) return ret;
                        }
                        break;
                    case 9:
                        {   int ret = slice_from_s(z, 1, s_4); /* <-, line 276 */
                            if (ret < 0) return ret;
                        }
                        break;
                    case 10:
                        {   int ret = slice_from_s(z, 1, s_5); /* <-, line 277 */
                            if (ret < 0) return ret;
                        }
                        break;
                    case 11:
                        {   int ret = slice_from_s(z, 1, s_6); /* <-, line 278 */
                            if (ret < 0) return ret;
                        }
                        break;
                    case 12:
                        {   int ret = slice_from_s(z, 1, s_7); /* <-, line 279 */
                            if (ret < 0) return ret;
                        }
                        break;
                    case 13:
                        {   int ret = slice_from_s(z, 1, s_8); /* <-, line 280 */
                            if (ret < 0) return ret;
                        }
                        break;
                    case 14:
                        {   int ret = slice_from_s(z, 1, s_9); /* <-, line 281 */
                            if (ret < 0) return ret;
                        }
                        break;
                    case 15:
                        {   int ret = slice_del(z); /* delete, line 282 */
                            if (ret < 0) return ret;
                        }
                        break;
                    case 16:
                        {   int ret = slice_from_s(z, 2, s_10); /* <-, line 285 */
                            if (ret < 0) return ret;
                        }
                        break;
                    case 17:
                        {   int ret = slice_from_s(z, 2, s_11); /* <-, line 286 */
                            if (ret < 0) return ret;
                        }
                        break;
                    case 18:
                        {   int ret = slice_from_s(z, 2, s_12); /* <-, line 287 */
                            if (ret < 0) return ret;
                        }
                        break;
                    case 19:
                        {   int ret = slice_from_s(z, 2, s_13); /* <-, line 288 */
                            if (ret < 0) return ret;
                        }
                        break;
                    case 20:
                        {   int ret = slice_from_s(z, 2, s_14); /* <-, line 289 */
                            if (ret < 0) return ret;
                        }
                        break;
                    case 21:
                        {   int ret = slice_from_s(z, 2, s_15); /* <-, line 290 */
                            if (ret < 0) return ret;
                        }
                        break;
                    case 22:
                        {   int ret = slice_from_s(z, 2, s_16); /* <-, line 291 */
                            if (ret < 0) return ret;
                        }
                        break;
                    case 23:
                        {   int ret = slice_from_s(z, 2, s_17); /* <-, line 292 */
                            if (ret < 0) return ret;
                        }
                        break;
                    case 24:
                        {   int ret = slice_from_s(z, 2, s_18); /* <-, line 293 */
                            if (ret < 0) return ret;
                        }
                        break;
                    case 25:
                        {   int ret = slice_from_s(z, 2, s_19); /* <-, line 294 */
                            if (ret < 0) return ret;
                        }
                        break;
                    case 26:
                        {   int ret = slice_from_s(z, 2, s_20); /* <-, line 295 */
                            if (ret < 0) return ret;
                        }
                        break;
                    case 27:
                        {   int ret = slice_from_s(z, 2, s_21); /* <-, line 296 */
                            if (ret < 0) return ret;
                        }
                        break;
                    case 28:
                        {   int ret = slice_from_s(z, 2, s_22); /* <-, line 297 */
                            if (ret < 0) return ret;
                        }
                        break;
                    case 29:
                        {   int ret = slice_from_s(z, 2, s_23); /* <-, line 298 */
                            if (ret < 0) return ret;
                        }
                        break;
                    case 30:
                        {   int ret = slice_from_s(z, 2, s_24); /* <-, line 299 */
                            if (ret < 0) return ret;
                        }
                        break;
                    case 31:
                        {   int ret = slice_from_s(z, 2, s_25); /* <-, line 300 */
                            if (ret < 0) return ret;
                        }
                        break;
                    case 32:
                        {   int ret = slice_from_s(z, 2, s_26); /* <-, line 301 */
                            if (ret < 0) return ret;
                        }
                        break;
                    case 33:
                        {   int ret = slice_from_s(z, 2, s_27); /* <-, line 302 */
                            if (ret < 0) return ret;
                        }
                        break;
                    case 34:
                        {   int ret = slice_from_s(z, 2, s_28); /* <-, line 303 */
                            if (ret < 0) return ret;
                        }
                        break;
                    case 35:
                        {   int ret = slice_from_s(z, 2, s_29); /* <-, line 304 */
                            if (ret < 0) return ret;
                        }
                        break;
                    case 36:
                        {   int ret = slice_from_s(z, 2, s_30); /* <-, line 305 */
                            if (ret < 0) return ret;
                        }
                        break;
                    case 37:
                        {   int ret = slice_from_s(z, 2, s_31); /* <-, line 306 */
                            if (ret < 0) return ret;
                        }
                        break;
                    case 38:
                        {   int ret = slice_from_s(z, 2, s_32); /* <-, line 307 */
                            if (ret < 0) return ret;
                        }
                        break;
                    case 39:
                        {   int ret = slice_from_s(z, 2, s_33); /* <-, line 308 */
                            if (ret < 0) return ret;
                        }
                        break;
                    case 40:
                        {   int ret = slice_from_s(z, 2, s_34); /* <-, line 309 */
                            if (ret < 0) return ret;
                        }
                        break;
                    case 41:
                        {   int ret = slice_from_s(z, 2, s_35); /* <-, line 310 */
                            if (ret < 0) return ret;
                        }
                        break;
                    case 42:
                        {   int ret = slice_from_s(z, 2, s_36); /* <-, line 311 */
                            if (ret < 0) return ret;
                        }
                        break;
                    case 43:
                        {   int ret = slice_from_s(z, 2, s_37); /* <-, line 312 */
                            if (ret < 0) return ret;
                        }
                        break;
                    case 44:
                        {   int ret = slice_from_s(z, 2, s_38); /* <-, line 313 */
                            if (ret < 0) return ret;
                        }
                        break;
                    case 45:
                        {   int ret = slice_from_s(z, 2, s_39); /* <-, line 314 */
                            if (ret < 0) return ret;
                        }
                        break;
                    case 46:
                        {   int ret = slice_from_s(z, 2, s_40); /* <-, line 315 */
                            if (ret < 0) return ret;
                        }
                        break;
                    case 47:
                        {   int ret = slice_from_s(z, 2, s_41); /* <-, line 316 */
                            if (ret < 0) return ret;
                        }
                        break;
                    case 48:
                        {   int ret = slice_from_s(z, 2, s_42); /* <-, line 317 */
                            if (ret < 0) return ret;
                        }
                        break;
                    case 49:
                        {   int ret = slice_from_s(z, 2, s_43); /* <-, line 318 */
                            if (ret < 0) return ret;
                        }
                        break;
                    case 50:
                        {   int ret = slice_from_s(z, 2, s_44); /* <-, line 319 */
                            if (ret < 0) return ret;
                        }
                        break;
                    case 51:
                        {   int ret = slice_from_s(z, 2, s_45); /* <-, line 320 */
                            if (ret < 0) return ret;
                        }
                        break;
                    case 52:
                        {   int ret = slice_from_s(z, 4, s_46); /* <-, line 323 */
                            if (ret < 0) return ret;
                        }
                        break;
                    case 53:
                        {   int ret = slice_from_s(z, 4, s_47); /* <-, line 324 */
                            if (ret < 0) return ret;
                        }
                        break;
                    case 54:
                        {   int ret = slice_from_s(z, 4, s_48); /* <-, line 325 */
                            if (ret < 0) return ret;
                        }
                        break;
                    case 55:
                        {   int ret = slice_from_s(z, 4, s_49); /* <-, line 326 */
                            if (ret < 0) return ret;
                        }
                        break;
                }
...
static int r_Normalize_post(struct SN_env * z) { /* forwardmode */
    int among_var;
    {   int c1 = z->c; /* do, line 337 */
        z->lb = z->c; z->c = z->l; /* backwards, line 339 */

        z->ket = z->c; /* [, line 340 */
        if (z->c - 1 <= z->lb || z->p[z->c - 1] >> 5 != 5 || !((124 >> (z->p[z->c - 1] & 0x1f)) & 1)) goto lab0; /* substring, line 340 */
        among_var = find_among_b(z, a_1, 5);
        if (!(among_var)) goto lab0;
        z->bra = z->c; /* ], line 340 */
        switch (among_var) { /* among, line 340 */
            case 0: goto lab0;
            case 1:
                {   int ret = slice_from_s(z, 2, s_50); /* <-, line 341 */
                    if (ret < 0) return ret;
                }
                break;
            case 2:
                {   int ret = slice_from_s(z, 2, s_51); /* <-, line 342 */
                    if (ret < 0) return ret;
                }
                break;
            case 3:
                {   int ret = slice_from_s(z, 2, s_52); /* <-, line 343 */
                    if (ret < 0) return ret;
                }
                break;
        }
    ...
    {   int c2 = z->c; /* do, line 348 */
        {   int i; for (i = z->I[0]; i > 0; i--) /* loop, line 348 */
            {                   {   int c3 = z->c; /* or, line 357 */
                    z->bra = z->c; /* [, line 351 */
                    if (z->c + 1 >= z->l || z->p[z->c + 1] >> 5 != 5 || !((124 >> (z->p[z->c + 1] & 0x1f)) & 1)) goto lab3; /* substring, line 351 */
                    ...
                    switch (among_var) { /* among, line 351 */
                        case 0: goto lab3;
                        case 1:
                            {   int ret = slice_from_s(z, 2, s_53); /* <-, line 352 */
                                if (ret < 0) return ret;
                            }
                            break;
                        case 2:
                            {   int ret = slice_from_s(z, 2, s_54); /* <-, line 353 */
                                if (ret < 0) return ret;
                            }
                            break;
                        case 3:
                            {   int ret = slice_from_s(z, 2, s_55); /* <-, line 354 */
                                if (ret < 0) return ret;
                            }
                            break;
                    }
...
static int r_Checks1(struct SN_env * z) { /* forwardmode */
    int among_var;
    z->I[0] = len_utf8(z->p); /* $word_len = <integer expression>, line 364 */
    z->bra = z->c; /* [, line 365 */
    if (z->c + 3 >= z->l || (z->p[z->c + 3] != 132 && z->p[z->c + 3] != 167)) return 0; /* substring, line 365 */
    among_var = find_among(z, a_3, 4);
    if (!(among_var)) return 0;
    z->ket = z->c; /* ], line 365 */
    switch (among_var) { /* among, line 365 */
        case 0: return 0;
        case 1:
            if (!(z->I[0] > 4)) return 0; /* $word_len > <integer expression>, line 366 */
            z->B[0] = 1; /* set is_noun, line 366 */
            z->B[1] = 0; /* unset is_verb, line 366 */
            z->B[2] = 1; /* set is_defined, line 366 */
            break;
        case 2:
            if (!(z->I[0] > 3)) return 0; /* $word_len > <integer expression>, line 367 */
            z->B[0] = 1; /* set is_noun, line 367 */
            z->B[1] = 0; /* unset is_verb, line 367 */
            z->B[2] = 1; /* set is_defined, line 367 */
            break;
    }
    return 1;
}
...
static int r_Checks2(struct SN_env * z) { /* backwardmode */
    int among_var;
    z->I[0] = len_utf8(z->p); /* $word_len = <integer expression>, line 374 */
    z->ket = z->c; /* [, line 375 */
    if (z->c - 1 <= z->lb || z->p[z->c - 1] != 169) return 0; /* substring, line 375 */
    among_var = find_among_b(z, a_4, 1);
    if (!(among_var)) return 0;
    z->bra = z->c; /* ], line 375 */
    switch (among_var) { /* among, line 375 */
        case 0: return 0;
        case 1:
            if (!(z->I[0] > 2)) return 0; /* $word_len > <integer expression>, line 376 */
            z->B[0] = 1; /* set is_noun, line 376 */
            z->B[1] = 0; /* unset is_verb, line 376 */
            break;
    }
    return 1;
}
...
static int r_Prefix_Step1(struct SN_env * z) { /* forwardmode */
    int among_var;
    z->I[0] = len_utf8(z->p); /* $word_len = <integer expression>, line 383 */
    z->bra = z->c; /* [, line 384 */
    if (z->c + 3 >= z->l || z->p[z->c + 3] >> 5 != 5 || !((188 >> (z->p[z->c + 3] & 0x1f)) & 1)) return 0; /* substring, line 384 */
    among_var = find_among(z, a_5, 5);
    if (!(among_var)) return 0;
    z->ket = z->c; /* ], line 384 */
    switch (among_var) { /* among, line 384 */
        case 0: return 0;
        case 1:
            if (!(z->I[0] > 3)) return 0; /* $word_len > <integer expression>, line 385 */
            {   int ret = slice_from_s(z, 2, s_56); /* <-, line 385 */
                if (ret < 0) return ret;
            }
            break;
        case 2:
            if (!(z->I[0] > 3)) return 0; /* $word_len > <integer expression>, line 386 */
            {   int ret = slice_from_s(z, 2, s_57); /* <-, line 386 */
                if (ret < 0) return ret;
            }
            break;
        case 3:
            if (!(z->I[0] > 3)) return 0; /* $word_len > <integer expression>, line 387 */
            {   int ret = slice_from_s(z, 2, s_58); /* <-, line 387 */
                if (ret < 0) return ret;
            }
            break;
        case 4:
            if (!(z->I[0] > 3)) return 0; /* $word_len > <integer expression>, line 388 */
            {   int ret = slice_from_s(z, 2, s_59); /* <-, line 388 */
                if (ret < 0) return ret;
            }
            break;
        case 5:
            if (!(z->I[0] > 3)) return 0; /* $word_len > <integer expression>, line 389 */
            {   int ret = slice_from_s(z, 2, s_60); /* <-, line 389 */
                if (ret < 0) return ret;
            }
            break;
    }
...
static int r_Prefix_Step2a(struct SN_env * z) { /* forwardmode */
    int among_var;
    z->I[0] = len_utf8(z->p); /* $word_len = <integer expression>, line 395 */
    z->bra = z->c; /* [, line 396 */
    if (z->c + 5 >= z->l || z->p[z->c + 5] != 132) return 0; /* substring, line 396 */
    among_var = find_among(z, a_6, 2);
    if (!(among_var)) return 0;
    z->ket = z->c; /* ], line 396 */
    switch (among_var) { /* among, line 396 */
        case 0: return 0;
        case 1:
            ...
            break;
        case 2:
            if (!(z->I[0] > 5)) return 0; /* $word_len > <integer expression>, line 398 */
...
static int r_Prefix_Step2b(struct SN_env * z) { /* forwardmode */
    int among_var;
    z->I[0] = len_utf8(z->p); /* $word_len = <integer expression>, line 403 */
    {   int c1 = z->c; /* not, line 404 */
        if (!(eq_s(z, 4, s_61))) goto lab0; /* literal, line 404 */
        return 0;
    lab0:
        z->c = c1;
    }
    {   int c2 = z->c; /* not, line 405 */
        if (!(eq_s(z, 4, s_62))) goto lab1; /* literal, line 405 */
        return 0;
    lab1:
        z->c = c2;
    }
    z->bra = z->c; /* [, line 406 */
    if (z->c + 1 >= z->l || (z->p[z->c + 1] != 129 && z->p[z->c + 1] != 136)) return 0; /* substring, line 406 */
    among_var = find_among(z, a_7, 2);
    if (!(among_var)) return 0;
    z->ket = z->c; /* ], line 406 */
    switch (among_var) { /* among, line 406 */
        case 0: return 0;
        case 1:
            ...
            break;
        case 2:
            if (!(z->I[0] > 3)) return 0; /* $word_len > <integer expression>, line 408 */
...
static int r_Prefix_Step3a_Noun(struct SN_env * z) { /* forwardmode */
    ...
    z->bra = z->c; /* [, line 414 */
    if (z->c + 3 >= z->l || (z->p[z->c + 3] != 132 && z->p[z->c + 3] != 167)) return 0; /* substring, line 414 */
    ...
    switch (among_var) { /* among, line 414 */
        case 0: return 0;
        case 1:
            if (!(z->I[0] > 5)) return 0; /* $word_len > <integer expression>, line 415 */
            {   int ret = slice_del(z); /* delete, line 415 */
                if (ret < 0) return ret;
            }
            break;
        case 2:
            if (!(z->I[0] > 4)) return 0; /* $word_len > <integer expression>, line 416 */
            {   int ret = slice_del(z); /* delete, line 416 */
                if (ret < 0) return ret;
            }
            break;
    }
...
static int r_Prefix_Step3b_Noun(struct SN_env * z) { /* forwardmode */
    int among_var;
    z->I[0] = len_utf8(z->p); /* $word_len = <integer expression>, line 421 */
    {   int c1 = z->c; /* not, line 422 */
        if (!(eq_s(z, 4, s_63))) goto lab0; /* literal, line 422 */
        return 0;
    lab0:
        z->c = c1;
    }
    z->bra = z->c; /* [, line 423 */
    among_var = find_among(z, a_9, 5); /* substring, line 423 */
    if (!(among_var)) return 0;
    z->ket = z->c; /* ], line 423 */
    switch (among_var) { /* among, line 423 */
        case 0: return 0;
        case 1:
            if (!(z->I[0] > 3)) return 0; /* $word_len > <integer expression>, line 424 */
        ...
        case 2:
            ...
            break;
        case 3:
            if (!(z->I[0] > 4)) return 0; /* $word_len > <integer expression>, line 426 */
        ...
        case 4:
            ...
            {   int ret = slice_from_s(z, 2, s_64); /* <-, line 427 */
                if (ret < 0) return ret;
            }
            break;
        case 5:
            if (!(z->I[0] > 3)) return 0; /* $word_len > <integer expression>, line 428 */
            {   int ret = slice_from_s(z, 2, s_65); /* <-, line 428 */
                if (ret < 0) return ret;
            }
            break;
    }
...
static int r_Prefix_Step3_Verb(struct SN_env * z) { /* forwardmode */
    int among_var;
    z->I[0] = len_utf8(z->p); /* $word_len = <integer expression>, line 434 */
    z->bra = z->c; /* [, line 435 */
    among_var = find_among(z, a_10, 4); /* substring, line 435 */
    if (!(among_var)) return 0;
    z->ket = z->c; /* ], line 435 */
    switch (among_var) { /* among, line 435 */
        case 0: return 0;
        case 1:
            if (!(z->I[0] > 4)) return 0; /* $word_len > <integer expression>, line 437 */
            {   int ret = slice_from_s(z, 2, s_66); /* <-, line 437 */
                if (ret < 0) return ret;
            }
            break;
        case 2:
            if (!(z->I[0] > 4)) return 0; /* $word_len > <integer expression>, line 438 */
            {   int ret = slice_from_s(z, 2, s_67); /* <-, line 438 */
                if (ret < 0) return ret;
            }
            break;
        case 3:
            if (!(z->I[0] > 4)) return 0; /* $word_len > <integer expression>, line 439 */
            {   int ret = slice_from_s(z, 2, s_68); /* <-, line 439 */
                if (ret < 0) return ret;
            }
            break;
        case 4:
            if (!(z->I[0] > 4)) return 0; /* $word_len > <integer expression>, line 440 */
            {   int ret = slice_from_s(z, 2, s_69); /* <-, line 440 */
                if (ret < 0) return ret;
            }
            break;
    }
...
static int r_Prefix_Step4_Verb(struct SN_env * z) { /* forwardmode */
    ...
    z->bra = z->c; /* [, line 446 */
    if (z->c + 5 >= z->l || z->p[z->c + 5] != 170) return 0; /* substring, line 446 */
    ...
    switch (among_var) { /* among, line 446 */
        case 0: return 0;
        case 1:
            if (!(z->I[0] > 4)) return 0; /* $word_len > <integer expression>, line 447 */
            z->B[1] = 1; /* set is_verb, line 447 */
            z->B[0] = 0; /* unset is_noun, line 447 */
            {   int ret = slice_from_s(z, 6, s_70); /* <-, line 447 */
                if (ret < 0) return ret;
            }
            break;
    }
...
static int r_Suffix_Noun_Step1a(struct SN_env * z) { /* backwardmode */
    int among_var;
    z->I[0] = len_utf8(z->p); /* $word_len = <integer expression>, line 455 */
    z->ket = z->c; /* [, line 456 */
    among_var = find_among_b(z, a_12, 10); /* substring, line 456 */
    if (!(among_var)) return 0;
    z->bra = z->c; /* ], line 456 */
    switch (among_var) { /* among, line 456 */
        case 0: return 0;
        case 1:
            if (!(z->I[0] >= 4)) return 0; /* $word_len >= <integer expression>, line 457 */
            {   int ret = slice_del(z); /* delete, line 457 */
                if (ret < 0) return ret;
            }
            break;
        case 2:
            if (!(z->I[0] >= 5)) return 0; /* $word_len >= <integer expression>, line 458 */
            {   int ret = slice_del(z); /* delete, line 458 */
                if (ret < 0) return ret;
            }
            break;
        case 3:
            if (!(z->I[0] >= 6)) return 0; /* $word_len >= <integer expression>, line 459 */
            {   int ret = slice_del(z); /* delete, line 459 */
                if (ret < 0) return ret;
            }
            break;
    }
...
static int r_Suffix_Noun_Step1b(struct SN_env * z) { /* backwardmode */
    int among_var;
    z->I[0] = len_utf8(z->p); /* $word_len = <integer expression>, line 463 */
    z->ket = z->c; /* [, line 464 */
    if (z->c - 1 <= z->lb || z->p[z->c - 1] != 134) return 0; /* substring, line 464 */
    among_var = find_among_b(z, a_13, 1);
    if (!(among_var)) return 0;
    z->bra = z->c; /* ], line 464 */
    switch (among_var) { /* among, line 464 */
        case 0: return 0;
        case 1:
            if (!(z->I[0] > 5)) return 0; /* $word_len > <integer expression>, line 465 */
            {   int ret = slice_del(z); /* delete, line 465 */
                if (ret < 0) return ret;
            }
            break;
    }
...
static int r_Suffix_Noun_Step2a(struct SN_env * z) { /* backwardmode */
    int among_var;
    z->I[0] = len_utf8(z->p); /* $word_len = <integer expression>, line 470 */
    z->ket = z->c; /* [, line 471 */
    among_var = find_among_b(z, a_14, 3); /* substring, line 471 */
    if (!(among_var)) return 0;
    z->bra = z->c; /* ], line 471 */
    switch (among_var) { /* among, line 471 */
        case 0: return 0;
        case 1:
            if (!(z->I[0] > 4)) return 0; /* $word_len > <integer expression>, line 472 */
            {   int ret = slice_del(z); /* delete, line 472 */
                if (ret < 0) return ret;
            }
            break;
    }
...
static int r_Suffix_Noun_Step2b(struct SN_env * z) { /* backwardmode */
    int among_var;
    z->I[0] = len_utf8(z->p); /* $word_len = <integer expression>, line 477 */
    z->ket = z->c; /* [, line 478 */
    if (z->c - 3 <= z->lb || z->p[z->c - 1] != 170) return 0; /* substring, line 478 */
    among_var = find_among_b(z, a_15, 1);
    if (!(among_var)) return 0;
    z->bra = z->c; /* ], line 478 */
    switch (among_var) { /* among, line 478 */
        case 0: return 0;
        case 1:
            if (!(z->I[0] >= 5)) return 0; /* $word_len >= <integer expression>, line 479 */
            {   int ret = slice_del(z); /* delete, line 479 */
                if (ret < 0) return ret;
            }
            break;
    }
...
static int r_Suffix_Noun_Step2c1(struct SN_env * z) { /* backwardmode */
    int among_var;
    z->I[0] = len_utf8(z->p); /* $word_len = <integer expression>, line 484 */
    z->ket = z->c; /* [, line 485 */
    if (z->c - 1 <= z->lb || z->p[z->c - 1] != 170) return 0; /* substring, line 485 */
    among_var = find_among_b(z, a_16, 1);
    if (!(among_var)) return 0;
    z->bra = z->c; /* ], line 485 */
    switch (among_var) { /* among, line 485 */
        case 0: return 0;
        case 1:
            if (!(z->I[0] >= 4)) return 0; /* $word_len >= <integer expression>, line 486 */
            {   int ret = slice_del(z); /* delete, line 486 */
                if (ret < 0) return ret;
            }
            break;
    }
...
static int r_Suffix_Noun_Step2c2(struct SN_env * z) { /* backwardmode */
    ...
    z->ket = z->c; /* [, line 491 */
    if (z->c - 1 <= z->lb || z->p[z->c - 1] != 169) return 0; /* substring, line 491 */
    ...
    switch (among_var) { /* among, line 491 */
        case 0: return 0;
        case 1:
            if (!(z->I[0] >= 3)) return 0; /* $word_len >= <integer expression>, line 492 */
...
static int r_Suffix_Noun_Step3(struct SN_env * z) { /* backwardmode */
    int among_var;
    z->I[0] = len_utf8(z->p); /* $word_len = <integer expression>, line 496 */
    z->ket = z->c; /* [, line 497 */
    if (z->c - 1 <= z->lb || z->p[z->c - 1] != 138) return 0; /* substring, line 497 */
    among_var = find_among_b(z, a_18, 1);
    if (!(among_var)) return 0;
    z->bra = z->c; /* ], line 497 */
    switch (among_var) { /* among, line 497 */
        case 0: return 0;
        case 1:
            if (!(z->I[0] >= 3)) return 0; /* $word_len >= <integer expression>, line 498 */
            {   int ret = slice_del(z); /* delete, line 498 */
                if (ret < 0) return ret;
            }
            break;
    }
...
static int r_Suffix_Verb_Step1(struct SN_env * z) { /* backwardmode */
    int among_var;
    z->I[0] = len_utf8(z->p); /* $word_len = <integer expression>, line 503 */
    z->ket = z->c; /* [, line 504 */
    among_var = find_among_b(z, a_19, 12); /* substring, line 504 */
    if (!(among_var)) return 0;
    z->bra = z->c; /* ], line 504 */
    switch (among_var) { /* among, line 504 */
        case 0: return 0;
        case 1:
            if (!(z->I[0] >= 4)) return 0; /* $word_len >= <integer expression>, line 505 */
            {   int ret = slice_del(z); /* delete, line 505 */
                if (ret < 0) return ret;
            }
            break;
        case 2:
            if (!(z->I[0] >= 5)) return 0; /* $word_len >= <integer expression>, line 506 */
            {   int ret = slice_del(z); /* delete, line 506 */
                if (ret < 0) return ret;
            }
            break;
        case 3:
            if (!(z->I[0] >= 6)) return 0; /* $word_len >= <integer expression>, line 507 */
            {   int ret = slice_del(z); /* delete, line 507 */
                if (ret < 0) return ret;
            }
            break;
    }
...
static int r_Suffix_Verb_Step2a(struct SN_env * z) { /* backwardmode */
    int among_var;
    z->I[0] = len_utf8(z->p); /* $word_len = <integer expression>, line 511 */
    z->ket = z->c; /* [, line 512 */
    among_var = find_among_b(z, a_20, 11); /* substring, line 512 */
    if (!(among_var)) return 0;
    z->bra = z->c; /* ], line 512 */
    switch (among_var) { /* among, line 512 */
        case 0: return 0;
        case 1:
            ...
            break;
        case 2:
            if (!(z->I[0] >= 4)) return 0; /* $word_len >= <integer expression>, line 514 */
        ...
        case 3:
            ...
            break;
        case 4:
            if (!(z->I[0] > 5)) return 0; /* $word_len > <integer expression>, line 516 */
            {   int ret = slice_del(z); /* delete, line 516 */
                if (ret < 0) return ret;
            }
            break;
        case 5:
            if (!(z->I[0] >= 6)) return 0; /* $word_len >= <integer expression>, line 517 */
...
static int r_Suffix_Verb_Step2b(struct SN_env * z) { /* backwardmode */
    int among_var;
    z->I[0] = len_utf8(z->p); /* $word_len = <integer expression>, line 522 */
    z->ket = z->c; /* [, line 523 */
    if (z->c - 3 <= z->lb || (z->p[z->c - 1] != 133 && z->p[z->c - 1] != 167)) return 0; /* substring, line 523 */
    among_var = find_among_b(z, a_21, 2);
    if (!(among_var)) return 0;
    z->bra = z->c; /* ], line 523 */
    switch (among_var) { /* among, line 523 */
        case 0: return 0;
        case 1:
            if (!(z->I[0] >= 5)) return 0; /* $word_len >= <integer expression>, line 524 */
...
static int r_Suffix_Verb_Step2c(struct SN_env * z) { /* backwardmode */
    int among_var;
    z->I[0] = len_utf8(z->p); /* $word_len = <integer expression>, line 530 */
    z->ket = z->c; /* [, line 531 */
    if (z->c - 1 <= z->lb || z->p[z->c - 1] != 136) return 0; /* substring, line 531 */
    among_var = find_among_b(z, a_22, 2);
    if (!(among_var)) return 0;
    z->bra = z->c; /* ], line 531 */
    switch (among_var) { /* among, line 531 */
        case 0: return 0;
        case 1:
            if (!(z->I[0] >= 4)) return 0; /* $word_len >= <integer expression>, line 532 */
            {   int ret = slice_del(z); /* delete, line 532 */
                if (ret < 0) return ret;
            }
            break;
        case 2:
            if (!(z->I[0] >= 6)) return 0; /* $word_len >= <integer expression>, line 533 */
...
static int r_Suffix_All_alef_maqsura(struct SN_env * z) { /* backwardmode */
    int among_var;
    z->I[0] = len_utf8(z->p); /* $word_len = <integer expression>, line 538 */
    z->ket = z->c; /* [, line 539 */
    if (z->c - 1 <= z->lb || z->p[z->c - 1] != 137) return 0; /* substring, line 539 */
    among_var = find_among_b(z, a_23, 1);
    if (!(among_var)) return 0;
    z->bra = z->c; /* ], line 539 */
    switch (among_var) { /* among, line 539 */
        case 0: return 0;
        case 1:
            {   int ret = slice_from_s(z, 2, s_71); /* <-, line 540 */
                if (ret < 0) return ret;
            }
            break;
    }
...
extern int arabic_UTF_8_stem(struct SN_env * z) { /* forwardmode */
    z->B[0] = 1; /* set is_noun, line 549 */
    z->B[1] = 1; /* set is_verb, line 550 */
    z->B[2] = 0; /* unset is_defined, line 551 */
    {   int c1 = z->c; /* do, line 554 */
        {   int ret = r_Checks1(z); /* call Checks1, line 554 */
            if (ret == 0) goto lab0;
            if (ret < 0) return ret;
        }
    lab0:
    ...
    z->lb = z->c; z->c = z->l; /* backwards, line 555 */

    {   int m2 = z->l - z->c; (void)m2; /* do, line 555 */
        {   int ret = r_Checks2(z); /* call Checks2, line 555 */
            if (ret == 0) goto lab1;
            if (ret < 0) return ret;
        }
    lab1:
    ...
    z->c = z->lb;
    {   int c3 = z->c; /* do, line 558 */
        {   int ret = r_Normalize_pre(z); /* call Normalize_pre, line 558 */
            if (ret == 0) goto lab2;
            if (ret < 0) return ret;
        }
    lab2:
    ...
    z->lb = z->c; z->c = z->l; /* backwards, line 561 */

    {   int m4 = z->l - z->c; (void)m4; /* do, line 563 */
        {   int m5 = z->l - z->c; (void)m5; /* or, line 577 */
            if (!(z->B[1])) goto lab5; /* Boolean test is_verb, line 566 */
            {   int m6 = z->l - z->c; (void)m6; /* or, line 572 */
                {   int i = 1;
                    while(1) { /* atleast, line 569 */
                        int m7 = z->l - z->c; (void)m7;
                        {   int ret = r_Suffix_Verb_Step1(z); /* call Suffix_Verb_Step1, line 569 */
                            if (ret == 0) goto lab8;
                            if (ret < 0) return ret;
                        }
                        i--;
                ...
                {   int m8 = z->l - z->c; (void)m8; /* or, line 570 */
                    {   int ret = r_Suffix_Verb_Step2a(z); /* call Suffix_Verb_Step2a, line 570 */
                        if (ret == 0) goto lab10;
                        if (ret < 0) return ret;
                    }
                    goto lab9;
                lab10:
                    z->c = z->l - m8;
                    {   int ret = r_Suffix_Verb_Step2c(z); /* call Suffix_Verb_Step2c, line 570 */
                        if (ret == 0) goto lab11;
                        if (ret < 0) return ret;
                    }
                    goto lab9;
            ...
            lab7:
                z->c = z->l - m6;
                {   int ret = r_Suffix_Verb_Step2b(z); /* call Suffix_Verb_Step2b, line 572 */
                    if (ret == 0) goto lab12;
                    if (ret < 0) return ret;
                }
                goto lab6;
            lab12:
                z->c = z->l - m6;
                {   int ret = r_Suffix_Verb_Step2a(z); /* call Suffix_Verb_Step2a, line 573 */
                    if (ret == 0) goto lab5;
                    if (ret < 0) return ret;
                }
            }
        ...
        lab5:
            z->c = z->l - m5;
            if (!(z->B[0])) goto lab13; /* Boolean test is_noun, line 578 */
            {   int m9 = z->l - z->c; (void)m9; /* try, line 581 */
                {   int m10 = z->l - z->c; (void)m10; /* or, line 583 */
                    {   int ret = r_Suffix_Noun_Step2c2(z); /* call Suffix_Noun_Step2c2, line 582 */
                        if (ret == 0) goto lab16;
                        if (ret < 0) return ret;
                    }
                    goto lab15;
                lab16:
                    z->c = z->l - m10;
                    /* not, line 583 */
                    if (!(z->B[2])) goto lab18; /* Boolean test is_defined, line 583 */
                    goto lab17;
                lab18:
                    {   int ret = r_Suffix_Noun_Step1a(z); /* call Suffix_Noun_Step1a, line 583 */
                        if (ret == 0) goto lab17;
                        if (ret < 0) return ret;
                    }
                    {   int m11 = z->l - z->c; (void)m11; /* or, line 585 */
                        {   int ret = r_Suffix_Noun_Step2a(z); /* call Suffix_Noun_Step2a, line 584 */
                            if (ret == 0) goto lab20;
                            if (ret < 0) return ret;
                        }
                        goto lab19;
                    lab20:
                        z->c = z->l - m11;
                        {   int ret = r_Suffix_Noun_Step2b(z); /* call Suffix_Noun_Step2b, line 585 */
                            if (ret == 0) goto lab21;
                            if (ret < 0) return ret;
                        }
                        goto lab19;
                    lab21:
                        z->c = z->l - m11;
                        {   int ret = r_Suffix_Noun_Step2c1(z); /* call Suffix_Noun_Step2c1, line 586 */
                            if (ret == 0) goto lab22;
                            if (ret < 0) return ret;
                        }
                        goto lab19;
                ...
                lab17:
                    z->c = z->l - m10;
                    {   int ret = r_Suffix_Noun_Step1b(z); /* call Suffix_Noun_Step1b, line 588 */
                        if (ret == 0) goto lab23;
                        if (ret < 0) return ret;
                    }
                    {   int m12 = z->l - z->c; (void)m12; /* or, line 590 */
                        {   int ret = r_Suffix_Noun_Step2a(z); /* call Suffix_Noun_Step2a, line 589 */
                            if (ret == 0) goto lab25;
                            if (ret < 0) return ret;
                        }
                        goto lab24;
                    lab25:
                        z->c = z->l - m12;
                        {   int ret = r_Suffix_Noun_Step2b(z); /* call Suffix_Noun_Step2b, line 590 */
                            if (ret == 0) goto lab26;
                            if (ret < 0) return ret;
                        }
                        goto lab24;
                    lab26:
                        z->c = z->l - m12;
                        {   int ret = r_Suffix_Noun_Step2c1(z); /* call Suffix_Noun_Step2c1, line 591 */
                            if (ret == 0) goto lab23;
                            if (ret < 0) return ret;
                        }
                    }
                ...
                lab23:
                    z->c = z->l - m10;
                    /* not, line 592 */
                    if (!(z->B[2])) goto lab28; /* Boolean test is_defined, line 592 */
                    goto lab27;
                lab28:
                    {   int ret = r_Suffix_Noun_Step2a(z); /* call Suffix_Noun_Step2a, line 592 */
                        if (ret == 0) goto lab27;
                        if (ret < 0) return ret;
                    }
                    goto lab15;
                lab27:
                    z->c = z->l - m10;
                    {   int ret = r_Suffix_Noun_Step2b(z); /* call Suffix_Noun_Step2b, line 593 */
            ...
            {   int ret = r_Suffix_Noun_Step3(z); /* call Suffix_Noun_Step3, line 595 */
                if (ret == 0) goto lab13;
                if (ret < 0) return ret;
            }
            goto lab4;
        lab13:
            z->c = z->l - m5;
            {   int ret = r_Suffix_All_alef_maqsura(z); /* call Suffix_All_alef_maqsura, line 601 */
                if (ret == 0) goto lab3;
                if (ret < 0) return ret;
            }
        }
    ...
    z->c = z->lb;
    {   int c13 = z->c; /* do, line 606 */
        {   int c14 = z->c; /* try, line 607 */
            {   int ret = r_Prefix_Step1(z); /* call Prefix_Step1, line 607 */
        ...
        {   int c15 = z->c; /* try, line 608 */
            {   int c16 = z->c; /* or, line 608 */
                {   int ret = r_Prefix_Step2a(z); /* call Prefix_Step2a, line 608 */
                    if (ret == 0) goto lab33;
                    if (ret < 0) return ret;
                }
                goto lab32;
            lab33:
                z->c = c16;
                {   int ret = r_Prefix_Step2b(z); /* call Prefix_Step2b, line 608 */
        ...
        {   int c17 = z->c; /* or, line 610 */
            {   int ret = r_Prefix_Step3a_Noun(z); /* call Prefix_Step3a_Noun, line 609 */
                if (ret == 0) goto lab35;
                if (ret < 0) return ret;
            }
            goto lab34;
        lab35:
            z->c = c17;
            if (!(z->B[0])) goto lab36; /* Boolean test is_noun, line 610 */
            {   int ret = r_Prefix_Step3b_Noun(z); /* call Prefix_Step3b_Noun, line 610 */
                if (ret == 0) goto lab36;
                if (ret < 0) return ret;
            }
            goto lab34;
        lab36:
            z->c = c17;
            if (!(z->B[1])) goto lab29; /* Boolean test is_verb, line 611 */
            {   int c18 = z->c; /* try, line 611 */
                {   int ret = r_Prefix_Step3_Verb(z); /* call Prefix_Step3_Verb, line 611 */
            ...
            {   int ret = r_Prefix_Step4_Verb(z); /* call Prefix_Step4_Verb, line 611 */
                if (ret == 0) goto lab29;
                if (ret < 0) return ret;
            }
        }
    ...
    {   int c19 = z->c; /* do, line 616 */
        {   int ret = r_Normalize_post(z); /* call Normalize_post, line 616 */
            if (ret == 0) goto lab38;
            if (ret < 0) return ret;
        }
    lab38:
